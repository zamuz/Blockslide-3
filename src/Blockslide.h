...
int digits[][13][2] = {
    ...
    { {0,0}, {1,0}, {1,0}, {1,1}, {1,1}, {1,2}, {1,2}, {1,2}, {1,3}, {1,3}, {0,4}, {1,4}, {2,4} },    // 1
    { {0,0}, {1,0}, {2,0}, {2,1}, {2,1}, {0,2}, {1,2}, {2,2}, {0,3}, {0,3}, {0,4}, {1,4}, {2,4} },    // 2
    { {0,0}, {1,0}, {2,0}, {2,1}, {2,1}, {0,2}, {1,2}, {2,2}, {2,3}, {2,3}, {0,4}, {1,4}, {2,4} },    // 3
    { {0,0}, {0,0}, {2,0}, {0,1}, {2,1}, {0,2}, {1,2}, {2,2}, {2,3}, {2,3}, {2,4}, {2,4}, {2,4} },    // 4
    { {0,0}, {1,0}, {2,0}, {0,1}, {0,1}, {0,2}, {1,2}, {2,2}, {2,3}, {2,3}, {0,4}, {1,4}, {2,4} },    // 5
    { {0,0}, {1,0}, {2,0}, {0,1}, {0,1}, {0,2}, {1,2}, {2,2}, {0,3}, {2,3}, {0,4}, {1,4}, {2,4} },    // 6
    { {0,0}, {1,0}, {2,0}, {2,1}, {2,1}, {2,2}, {2,2}, {2,2}, {2,3}, {2,3}, {2,4}, {2,4}, {2,4} },    // 7
...
//  04 14 24    10 11 12
    // 00     01     02     03     04     05     06     07     08     09     10     11     12
    { {2,0}, {2,0}, {2,0}, {2,1}, {2,1}, {2,2}, {2,2}, {2,2}, {2,3}, {2,3}, {2,4}, {2,4}, {2,4} },    //   // 43 // START_TOP_LEFT
    { {0,0}, {0,0}, {0,0}, {0,1}, {0,1}, {0,2}, {0,2}, {0,2}, {0,3}, {0,3}, {0,4}, {0,4}, {0,4} },    //   // 44 // START_TOP_RIGHT
    { {2,0}, {2,0}, {2,0}, {2,1}, {2,1}, {2,2}, {2,2}, {2,2}, {2,3}, {2,3}, {2,4}, {2,4}, {2,4} },    //   // 45 // START_MIDDLE_LEFT
    { {0,0}, {0,0}, {0,0}, {0,1}, {0,1}, {0,2}, {0,2}, {0,2}, {0,3}, {0,3}, {0,4}, {0,4}, {0,4} },    //   // 46 // START_MIDDLE_RIGHT
    { {2,0}, {2,0}, {2,0}, {2,1}, {2,1}, {2,2}, {2,2}, {2,2}, {2,3}, {2,3}, {2,4}, {2,4}, {2,4} },    //   // 47 // START_BOTTOM_LEFT
    { {0,0}, {0,0}, {0,0}, {0,1}, {0,1}, {0,2}, {0,2}, {0,2}, {0,3}, {0,3}, {0,4}, {0,4}, {0,4} },    //   // 48 // START_BOTTOM_RIGHT
};
